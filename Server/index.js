import calculateNextSeatNumber from './service/SeatNumberCalculator.js';
//import { 
//  broadcastUserlist,
//  broadcastDraftStatus,
//  broadcastCanalDredger
//  } from './service/Broadcasts.js';
import shuffleArray from './service/Utils.js';
	...
	if (checkIfRoundIsDone(draft.table)) {
      ...
      const playerOnTheRight =
        users[draft.table[`seat${[calculateNextSeatNumber(
		  ...
		  connections[draft.players[i].uuid].send(JSON.stringify({
        status: "OK",
        type: "Neighbours",
...
const flask_url = "http://flaskserver:5002";

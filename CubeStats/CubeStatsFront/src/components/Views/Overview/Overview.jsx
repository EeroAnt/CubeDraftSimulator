...
export const Overview = ({ data }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center">
      ...
      <button className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition duration-300" onClick={() => console.log(singleColorAverages)}>
        <>Back to Cube</>
      </button>
      {data && (
        <>
